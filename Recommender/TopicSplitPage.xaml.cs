...
namespace Recommender
{
    ...
    public sealed partial class TopicSplitPage : Page
    {
        ...
        public TopicSplitPage()
        {
            ...
            this.navigationHelper.GoBackCommand = new Recommender.Common.RelayCommand(() => this.GoBack(), () => this.CanGoBack());
        ...
        private void navigationHelper_SaveState(object sender, SaveStateEventArgs e)
        {
            ...
            {
                var selectedItem = (ReDataItem)this.itemsViewSource.View.CurrentItem;
