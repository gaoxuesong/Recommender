...
{
    public class IndividualBtn : Button
    {
        /// <summary>
        /// Identifies the <see cref="NormalImage"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty NormalImageProperty =
            DependencyProperty.Register("NormalImage", typeof(ImageSource), typeof(IndividualBtn), new PropertyMetadata(null));

        /// <summary>
        /// Identifies the <see cref="HoverImage"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty HoverImageProperty =
            DependencyProperty.Register("HoverImage", typeof(ImageSource), typeof(IndividualBtn), new PropertyMetadata(null));
        ...
        public IndividualBtn()
        {
            this.DefaultStyleKey = typeof(IndividualBtn);
        }
    }
}
