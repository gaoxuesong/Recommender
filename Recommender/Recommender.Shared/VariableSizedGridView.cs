...
namespace Recommender
{
    public class VariableSizedGridView : GridView
    {
        ...
        private const int VirtualGroupMembers = 27;

        public VariableSizedGridView()
        {
            _sequence = new List<Size> { 
                LayoutSizes.PrimaryItem, LayoutSizes.NormalItem, LayoutSizes.NormalItem, 
                LayoutSizes.WideItem, LayoutSizes.NormalItem, LayoutSizes.NormalItem, LayoutSizes.NormalItem, LayoutSizes.NormalItem,
                LayoutSizes.WideItem, LayoutSizes.NormalItem, LayoutSizes.NormalItem, LayoutSizes.PrimaryItem, LayoutSizes.NormalItem, 
                LayoutSizes.NormalItem, LayoutSizes.WideItem, LayoutSizes.NormalItem, LayoutSizes.NormalItem, LayoutSizes.NormalItem,
                LayoutSizes.PrimaryItem, LayoutSizes.WideItem, 
                LayoutSizes.NormalItem, LayoutSizes.NormalItem,LayoutSizes.WideItem, LayoutSizes.NormalItem, LayoutSizes.WideItem,
                LayoutSizes.NormalItem, LayoutSizes.NormalItem
            };
        }
    ...
    public static class LayoutSizes {
        ...
        public static Size WideItem = new Size(2, 1);
        public static Size RectangleItem = new Size(1,2);
