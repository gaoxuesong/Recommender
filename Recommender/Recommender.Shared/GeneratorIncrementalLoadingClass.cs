...
namespace Recommender
{
    ...
    {
        private const uint MAX_COUNT = 100;

        public GeneratorIncrementalLoadingClass(Func<int, T> generator)
        {
        ...
        {
            _generator = generator;
            _maxCount = (maxCount > MAX_COUNT) ? MAX_COUNT : maxCount;
        }
